...
export postfix=" --query '{vmName:name,OsDiskName:storageProfile.osDisk.name, OsDiskCaching:storageProfile.osDisk.caching,DataDiskName:storageProfile.dataDisks[].name,DataDiskCaching:storageProfile.dataDisks[].caching}';echo ',';"
